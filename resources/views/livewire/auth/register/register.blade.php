                    ...
                    <div class="col-12 col-md-8">
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" wire:model.live="tipo_usuario" id="tipo_cliente" value="cliente">
                                <label class="form-check-label" for="tipo_cliente">Quiero comprar</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" wire:model.live="tipo_usuario" id="tipo_empresa" value="empresa">
