        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-light">
                <div class="material-form-group-with-icon">
                    ...
                    <label for="searchProduct" class="material-form-label">Buscar rol por nombre ...</label>
                    ...
                    <div class="card-body d-flex flex-column">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <br>
                                <small class="text-muted">ID: {{ $reg->id }} | {{ $reg->permissions->count() }}
                                    permisos</small>
                            </div>
                            <div class="btn-group">
                                @can('rol-edit')
                                <button wire:click="openModal({{ $reg->id }})" class="btn btn-sm btn-outline-info"
                                    title="Editar">
                                ...
                                <button wire:click="openConfirmModal({{ $reg->id }})"
                        ...
                        <div class="mb-2">
                            ...
                            <div class="d-flex flex-wrap mt-1">
                                ...
                                <span
                                    class="badge bg-primary-subtle text-primary-emphasis rounded-pill me-1 mb-1 fw-normal">
                        ...
                        <div class="text-center text-muted p-3">
                            <i class="fa-solid fa-key d-block mb-2 fs-4"></i>
    ...
    <div class="modal fade show" style="display: block;" tabindex="-1" x-data
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                <form wire:key="modal-role-{{ $roleId ?? 'new' }}" x-data="{
                    ...
                    <div class="modal-body" style="max-height: 75vh; overflow-y: auto;">
                        ...
                        <div class="mb-4">
                            <div class="material-form-group-with-icon">
                                ...
                                <input id="name" type="text" wire:model="name"
                                    ...
                                    placeholder=" " @if($name==='super_admin' ) readonly @endif>
                                <label for="name" class="material-form-label">Nombre del Rol <span
                                        class="text-danger">*</span></label>
                            </div>
                            <small class="text-muted d-block mt-1">El nombre debe ser único y en minúsculas (ej:
                                vendedor).</small>
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="card-title text-primary"><i class="fa-solid fa-key me-2"></i>Asignar Permisos
                            </h5>
                        ...
                        <div class="row">
                            <template x-for="(permissionsInGroup, groupName) in groupedPermissions" :key="groupName">
                                <div class="col-md-6 col-lg-3 mb-4">
                                    <h6 class="text-muted border-bottom pb-2 mb-2 text-capitalize"
                                        x-text="groupName.replace('_', ' ')"></h6>
                                    <template x-for="permission in permissionsInGroup" :key="permission">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label"
                                                :for="'permiso_' + permission.replace(/[^a-zA-Z0-9]/g, '_')"
                    ...
                    <div class="modal-footer">
                        ...
                        {{-- El @entangle ya sincroniza 'selectedPermissions', así que el método saveRole ya no necesita el parámetro --}}
                        <button type="button" class="btn btn-primary" @click="$wire.saveRole()">
                            <span wire:loading.remove wire:target="saveRole"><i
                                    class="fa-solid fa-floppy-disk me-1"></i> Guardar Rol</span>
                            <span wire:loading wire:target="saveRole" class="spinner-border spinner-border-sm"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>¿Estás seguro de que quieres eliminar el rol <strong>{{ $roleToDelete->name ?? '' }}</strong>?
                    </p>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" wire:click="deleteRole">
                        ...
                        <span wire:loading wire:target="deleteRole" class="spinner-border spinner-border-sm"
                            role="status" aria-hidden="true"></span>
                    </button>
                </div>
            </div>
