                ...
                <div class="modal-body">
                    <form wire:submit.prevent="saveUser" wire:loading.class="pe-none opacity-50" novalidate>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        wire:model.defer="name" id="name" placeholder="Ej: Juan Pérez">
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        wire:model.defer="email" id="email" placeholder="ejemplo@correo.com">
                                </div>
                        ...
                        <div class="row" x-data="{ 
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="password" class="form-label">Contraseña @if(!$isEditMode)<span
                                ...
                                <div class="input-group">
                                    ...
                                    <input :type="showPassword ? 'text' : 'password'"
                                        ...
                                        wire:model.defer="password" id="password" autocomplete="new-password">
                                ...
                                @if($isEditMode)<small class="form-text text-muted">Dejar en blanco para no
                                    cambiar.</small>@endif
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6 mb-3">
                                <label for="role" class="form-label">Rol del Usuario <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fa-solid fa-user-tag"></i></span>
                                    <select class="form-select @error('role') is-invalid @enderror"
                                        wire:model.live="role" id="role">
                            ...
                            @if(auth()->user()->hasRole('super_admin') && in_array($role, ['admin', 'vendedor',
                            'repartidor']))
                            <div class="col-md-6 mb-3">
                                <label for="empresaOption" class="form-label">Empresa <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fa-solid fa-building"></i></span>
                                    <select
                                        class="form-select @error('empresaOption') is-invalid @enderror @error('empresa_id') is-invalid @enderror"
                                        wire:model.live="empresaOption" id="empresaOption" @if($isEditMode) disabled
                                        @endif>
                                        @if(!$isEditMode)
                                        ...
                                        @else
                                        <option value="{{ $empresa_id }}" selected>
                                            {{ \App\Models\Empresa::find($empresa_id)->nombre ?? 'Sin empresa' }}
                                        </option>
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-check form-switch fs-5">
                                    <input class="form-check-input" type="checkbox" role="switch" id="activoSwitch"
                                        x-model="activo" wire:model.live="activo">
                                    <label class="form-check-label" :class="activo ? 'text-success' : 'text-danger'"
                                        for="activoSwitch" x-text="activo ? 'Activo' : 'Inactivo'"></label>
                                </div>
                            </div>
                        </div>
                        @endif
                        ...
                        <div x-data="{ show: false }" x-init="() => { setTimeout(() => show = true, 50) }" x-show="show"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="empresa_nombre" class="form-label">Nombre Empresa <span
                                            class="text-danger">*</span></label>
                                    <input type="text"
                                        class="form-control @error('empresa_nombre') is-invalid @enderror"
                                        wire:model.defer="empresa_nombre" id="empresa_nombre">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('empresa_rubro') is-invalid @enderror"
                                        wire:model.defer="empresa_rubro" id="empresa_rubro">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        wire:model.defer="empresa_telefono_whatsapp" id="empresa_telefono_whatsapp">
