<div class="dashboard-header">
    ...
    <div class="d-none d-lg-flex">
        ...
        <div class="header-metric"><div class="icon" style="background-color: var(--kpi-purple);"><i class="fas fa-building"></i></div><div><div class="value">{{ $totalEmpresas ?? 0 }}</div><div class="label">Empresas</div></div></div>
