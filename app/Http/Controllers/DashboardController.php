...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        // Redirigir al cliente a la bienvenida si intenta acceder al dashboard
        if ($user->hasRole('cliente')) {
            return redirect()->route('welcome');
        }
        
        // La vista 'dashboard' ahora solo contiene <livewire:dashboard />
        // El componente se encargará de toda la lógica.
